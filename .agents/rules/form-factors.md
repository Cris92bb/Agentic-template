...
- On Linux, build custom title bars with `WindowControlService` (drag/resize/close over `MethodChannel('app/window')`); drag and resize work on X11 but are ignored by most Wayland compositors.
