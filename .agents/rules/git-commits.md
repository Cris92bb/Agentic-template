...
- **Code & Documentation Consistency Check**: Before creating any commit that introduces, removes, or alters functionality, architecture, endpoints, models, tokens, shortcuts, or form factors, scan and check related markdown documentation (`README.md`, `docs/`, `.agents/rules/`) and update them in lockstep to prevent drift.
